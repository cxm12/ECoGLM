# 实验一 all 数据集上Ours  TokenAlign3.py
...
import os
from E1_VQTokenizer import NeuralVQVAE
from data import DataLoader, BCIFingersDataset_TT, MillerFingersDataset_TT
import math
...
def train_alignment64():
    ...
    warmup_scheduler = get_cosine_schedule_with_warmup(optimizer, 
                num_warmup_steps=WARMUP_EPOCHS, num_training_steps=EPOCHS)
    ...
    for epoch in range(EPOCHS):
        ...
        if patience_counter > 180: # 如果 没提升则停止
            print("触发早停，训练结束。")
            break
...
if __name__ == "__main__":
    ...
    if subset == 'BCI_Competion4_dataset4_data_fingerflexions':            
        save_path = '/mnt/home/user1/MCX/EEGLM/ECogLM/checkpoints/BCI Competition IV/TokenAlign_vocab6-4_ratio6/'
        VQVAEmodelpath = "/mnt/home/user1/MCX/EEGLM/ECogLM/checkpoints/BCI Competition IV/VQTokenizer_c%d_4/best_vqvae_model.pth" % codebook
        ...
        save_path = "/mnt/home/user1/MCX/EEGLM/ECogLM/checkpoints/Stanford/TokenAlign/%s_vocab6-4_ratio6/" % (subset) # 64-2
        VQVAEmodelpath = "/mnt/home/user1/MCX/EEGLM/ECogLM/checkpoints/Stanford/VQTokenizer/%s_c%d_4_ratio6/best_vqvae_model.pth" % (subset, codebook)
